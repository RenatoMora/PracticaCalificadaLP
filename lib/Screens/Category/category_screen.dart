            ...
            child: Column(
              ...
              children:<Widget> [
                ...
                const Text("Classify transaction",
                  style: TextStyle(
                    wordSpacing: 6,
                    color: Color.fromARGB(255, 77, 34, 194),
                ...
                const Text("\nClassify this transaction into a \nparticular category\n",
                  style: TextStyle(
                    color: Color.fromARGB(255, 3, 97, 126), 
                    fontSize: 18,  
                  ),
                ),
                ...
                Expanded(
                  ...
                  children: [
                    CategoryCard(
                      title: "General",
                      svgimg: "assets/icons/010-book.svg",
                      press: (){},
                    ),

                    CategoryCard(
                      title: "Transport",
                      svgimg: "assets/icons/0009-train.svg",
                      press: (){},
                    ),

                    CategoryCard(
                      title: "Shopping",
                      svgimg: "assets/icons/005-online-shopping.svg",
                      press: (){},
                    ),

                    CategoryCard(
                      title: "Bills",
                      svgimg: "assets/icons/006-bill.svg",
                      press: (){},
                    ),

                    CategoryCard(
                      title: "Entertaiment",
                      svgimg: "assets/icons/008-popcorn.svg",
                      press: (){},
                    ),

                    CategoryCard(
                      title: "Next",
                      svgimg: "assets/icons/002-feature.svg",
                      press: (){},
                    ),

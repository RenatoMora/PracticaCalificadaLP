    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: selectedIndex == index ? Color.fromARGB(202, 236, 22, 75):Color.fromARGB(255, 226, 150, 226),
        ...
        child: Text(
            ...
            style: TextStyle(
              ...
              // ignore: prefer_const_constructors
              color: selectedIndex == index ? Colors.white :Color.fromARGB(255, 255, 255, 255),
